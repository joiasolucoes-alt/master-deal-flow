...
export const FREIGHT_CHECKLIST_CATALOG: FreightChecklistItem[] = [
  // Motorista
  {
    ...
    helper: "Categoria compatível com o veículo.",
  },
  { type: "driver_id", label: "CPF/RG (ou CNH com CPF)", block: "driver", requiredFor: "contract" },
  {
    type: "driver_contact",
    label: "Contato/WhatsApp do motorista",
    block: "driver",
    requiredFor: "contract",
    helper: "Necessário para envio do link e coleta.",
  },
  {
    type: "driver_employment",
    label: "Vínculo (autônomo/transportadora)",
    block: "driver",
    requiredFor: "contract",
  },
  {
    ...
    helper: "Se o pagamento for direto ao motorista.",
  },
  {
    type: "driver_selfie",
    label: "Foto/selfie do motorista",
    block: "driver",
    requiredFor: "optional",
  },
  ...
  {
    type: "vehicle_crlv",
    label: "CRLV do cavalo/caminhão",
    block: "vehicle",
    requiredFor: "contract",
  },
  {
    type: "vehicle_crlv_trailer",
    label: "CRLV da carreta",
    block: "vehicle",
    requiredFor: "optional",
    helper: "Obrigatório quando houver conjunto com carreta.",
  },
  { type: "vehicle_antt", label: "RNTRC / ANTT", block: "vehicle", requiredFor: "contract" },
  {
    type: "vehicle_owner_doc",
    label: "Documento do proprietário do veículo",
    block: "vehicle",
    requiredFor: "optional",
    helper: "Quando o veículo não é da transportadora/motorista.",
  },
  {
    type: "vehicle_owner_authorization",
    label: "Autorização de uso do veículo",
    block: "vehicle",
    requiredFor: "optional",
    helper: "Quando o motorista não é o proprietário.",
  },

  // Operação
  {
    type: "operation_proposal",
    label: "Proposta de frete",
    block: "operation",
    requiredFor: "contract",
  },
  {
    type: "operation_contract",
    label: "Contrato / aceite do frete",
    block: "operation",
    requiredFor: "contract",
  },
  {
    type: "operation_collection_order",
    label: "Ordem de coleta / carregamento",
    block: "operation",
    requiredFor: "release_driver",
  },
  {
    type: "operation_invoice",
    label: "NF da mercadoria",
    block: "operation",
    requiredFor: "release_driver",
  },
  {
    type: "operation_cte_mdfe",
    label: "CT-e / MDF-e",
    block: "operation",
    requiredFor: "optional",
    helper: "Depende de quem emite o documento fiscal.",
  },
  {
    type: "operation_insurance",
    label: "Seguro / averbação da carga",
    block: "operation",
    requiredFor: "optional",
  },
  {
    type: "operation_payment_proof",
    label: "Comprovante pagamento / sinal",
    block: "operation",
    requiredFor: "optional",
    helper: "Quando exigido antes da coleta.",
  },
  {
    type: "operation_toll_voucher",
    label: "Vale-pedágio / comprovante",
    block: "operation",
    requiredFor: "optional",
  },
  ...
  {
    type: "cargo_mopp",
    label: "Curso MOPP + ficha de emergência",
    block: "operation",
    requiredFor: "optional",
    helper: "Obrigatório para carga perigosa.",
  },
  {
    type: "cargo_aet",
    label: "AET (autorização especial de trânsito)",
    block: "operation",
    requiredFor: "optional",
    helper: "Obrigatório para excesso de peso/dimensão.",
  },
  {
    type: "cargo_hygiene",
    label: "Comprovante de higienização",
    block: "operation",
    requiredFor: "optional",
    helper: "Obrigatório para alimentos/carga sensível.",
  },
  {
    type: "cargo_risk_management",
    label: "Gerenciadora de risco / PGR",
    block: "operation",
    requiredFor: "optional",
    helper: "Obrigatório para carga com rastreamento.",
  },

  // Final
  {
    type: "operation_delivery_receipt",
    label: "Canhoto / comprovante de entrega",
    block: "delivery",
    requiredFor: "finalize",
  },
];
...
export function getChecklistStatus(
  ...
  const countBlock = (block: FreightChecklistBlock, gate: "contract" | "release_driver") => {
