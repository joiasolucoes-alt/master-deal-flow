...
const statusTone: Record<string, string> = {
  ...
  "Aguardando carregamento": "border-transparent bg-warning-soft text-warning",
  "Em carregamento": "border-transparent bg-warning-soft text-warning",
  "Em separação": "border-transparent bg-warning-soft text-warning",
  "Em rota": "border-transparent bg-primary-soft text-primary",
  "Mercadoria descarregada": "border-transparent bg-warning-soft text-warning",
